...
<div class="page-header">
    <h2 class="header-title">Edit Penjualan</h2>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{route('sales.update', $transaction->id)}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input name="customer" id="" class="form-control" value="{{$transaction->customer}}">
                        </div>
                    </div>
                    <table id="table-detail" class="table">
                        ...
                        <tbody class="tbody" id="tDatas">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sub_total[]" class="form-control total" id="total_{{ $key }}"
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="" class="form-control">
                                    ...
                                    <option value="2" {{$transaction->status == 2 ? 'selected' : ''}}>Ordered</option>
